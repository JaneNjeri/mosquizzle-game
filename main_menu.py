...
from src.mos_control import MalariaControlGame
from src.mos_genus_quizzle import MosGenusGuessingGame
from src.mos_species_quizzle import MosSpeciesGuessingGame
